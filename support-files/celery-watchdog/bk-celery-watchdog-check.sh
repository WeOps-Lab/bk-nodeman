...
APP_CODE="${APP_ID:-${BK_CELERY_WATCHDOG_APP_CODE:-bk_nodeman}}"
...
SUPERVISOR_CONF="${BK_CELERY_WATCHDOG_SUPERVISOR_CONF:-/data/bkce/etc/supervisor-bknodeman-nodeman.conf}"
...
PYTHON_BIN=""
STATE_DIR="${BK_CELERY_WATCHDOG_STATE_DIR:-${BK_LOG_DIR:-/data/bkce/logs/bknodeman}/celery-watchdog}"
...
init_queue_mapping() {
    ...
    Q2W[default]="nodeman_celery_default:*"
    Q2W[backend]="nodeman_celery_backend:*"
    Q2W[backend_additional_task]="nodeman_celery_backend_additional:*"
    Q2W[pipeline]="nodeman_pipeline_worker:*"
    Q2W[pipeline_priority]="nodeman_pipeline_worker:*"
    Q2W[service_schedule]="nodeman_pipeline_schedule:*"
    Q2W[service_schedule_priority]="nodeman_pipeline_schedule:*"
    Q2W[pipeline_additional_task]="nodeman_pipeline_additional:*"
    Q2W[pipeline_additional_task_priority]="nodeman_pipeline_additional:*"
}
