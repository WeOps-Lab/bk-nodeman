...
from apps.exceptions import AuthOverdueException, ApiResultError
from apps.node_man import constants, models
from apps.utils import concurrent, exc, sync
from apps.utils.exc import ExceptionHandler
from common.api import JobApi, CCApi
...
class InstallService(base.AgentBaseService, remote.RemoteServiceMixin):
    ...
    @base.RetryHandler(interval=3, retry_times=2, exception_types=[ApiResultError])
